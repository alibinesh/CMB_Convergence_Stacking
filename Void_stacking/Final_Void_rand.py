...
void_r_ang = void_r_ang[0]
void_RA = void_RA[0]
void_Dec = void_Dec[0]
void_r_avg = void_r_avg[0]
void_r_eff = void_r_eff[0]
void_r_eff_avg = void_r_eff_avg[0]
...
im = plt.imshow(D6_smap, origin='lower',cmap=cm.jet, vmin = -0.05, vmax = 0.05)
ax=plt.gca()
...
plt.title("Stacked Random Locations for " + str(D6_Counter) + " Voids")
plt.xlabel("[Degrees]")
plt.ylabel("[Degrees]")
